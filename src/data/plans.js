...
export const PLANS = [
  ...
  },
  {
    ...
    annualPrice: '299.99',
    period: '/ month',
    billing: '12-month minimum commitment required. Monthly payment option is available.',
    popular: false,
    cta: 'Choose VIP Lite',
    ...
    features: [
      'Access to 4 monthly TITANS events',
      '4 coffee mornings with subject-matter experts (£500 value)',
      '2 site tours on membership project (£400-£600 value)',
      'Access to all speaker videos (£100 x 9 events £900 value)',
      'TITANS Concierge',
      'Deal Clinic',
      'Network with 100+ property professionals',
      'Hot food buffet & refreshments at the main event',
      '1 Christmas party chargeable; members pay CP directly',
      'Three additional social events a year (experiences, paid individually, self-paid)',
  ...
  },
  {
    ...
    annualPrice: '647.99',
    period: '/ month',
    billing: '12-month minimum commitment required. Monthly payment option available.',
    popular: true,
    ...
    features: [
      'Access to 9 monthly TITANS events',
      '9 coffee mornings with subject-matter experts (£1,000 value)',
      '4 to 6 site tours a year (£400-£600 value)',
      'Access to all speaker videos (£100 x 9 events £900 value)',
      'TITANS Concierge',
      'Deal Clinic',
      'Network with 100+ property professionals',
      'Hot food buffet & refreshments at the main event',
      '1 Summer party hosted by Manni',
      '1 Christmas party chargeable; members pay CP directly',
      'Three additional social events a year (experiences, paid individually)',
      'Part of the TITANS WhatsApp community',
      'Access to TITANS Community & Power Team',
      '30 mins introductory session with Manni (£297 value)',
      'Bring a guest at discounted price',
    ],
    stack: [
  ...
  },
  {
    ...
    price: '300',
    period: '/ month',
    billing: 'Monthly payment option is available.',
    popular: false,
    cta: 'Choose VIP Gold',
